    ...
    return [
      HoverPopupMenuButton<String>(
        ...
        itemBuilder: (ctx) => [
          ...
          PopupMenuItem(
            value: 'top',
            child: _popupRow(Icons.align_vertical_top, l.alignTop, tooltip: l.ttAlignTop),
          ),
          PopupMenuItem(
            value: 'centerV',
            child: _popupRow(
          ...
          if (canvasData.selectedCardIds.length >= 3) ...[
            ...
            PopupMenuItem(
              value: 'distH',
              child: _popupRow(Icons.space_bar, l.distributeH, tooltip: l.ttDistributeH),
            ),
            PopupMenuItem(
              value: 'distV',
              child: _popupRow(Icons.view_headline, l.distributeV, tooltip: l.ttDistributeV),
            ),
          ],
        ],
      ),
  ...
  Widget _buildCreatePopup(ThemeData theme, AppLocalizations l) {
    return HoverPopupMenuButton<String>(
      ...
      itemBuilder: (ctx) => [
        PopupMenuItem(
          value: 'container',
          child: _popupRow(Icons.crop_square, l.tooltipContainer, tooltip: l.ttContainer),
        ),
        PopupMenuItem(
          value: 'freehand',
          child: _popupRow(
